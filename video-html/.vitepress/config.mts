 ...
 *   video         e.g. "ai", "java", "clickhouse"
 *   /video/       e.g. "/ai/", "/clickhouse/"
 *   视频全栈      e.g. "AI 工程全栈"
 *   系统化学习视频处理 - 编解码原理 / FFmpeg / 流媒体 / AI 视频算法 - 12 大类 · 50+ 节点 · 60+ 内容页       e.g. "系统化学习 AI 工具..."
 *   #a855f7     e.g. "#8b5cf6"
 *   zh-CN       e.g. "zh-CN"
 *   视频处理全栈 - 编解码原理 / FFmpeg / AI 视频 · 🏠 <a href="https://java-px.bot.cd/" target="_blank">门户首页</a>  e.g. "AI 工程全栈 - 工具 / 大模型 / SDK / Agent"
...
export default withMermaid(defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:site_name', content: '视频全栈' }],
