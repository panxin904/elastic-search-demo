#!/usr/bin/env python3
"""Generate 7 hand-written chapter overviews for chaos-html.

Uses triple-quoted raw strings (r'''...''') to avoid ALL adjacent-string issues.
"""
...
def w(rel: str, title: str, sections: list[tuple[str, str]]) -> None:
    """Write a markdown file with frontmatter + sections."""
    parts = [f'---\ntitle: {title}\n---\n', f'# {title}\n']
...
w('01-foundations/overview.md', '混沌工程基础总览', [
    ('什么是混沌工程', r'''
...
'''),
    ...
    ('稳态假设（Steady-State Hypothesis）', r'''
