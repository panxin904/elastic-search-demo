...
export default withMermaid(defineConfig({
  ...
  mermaid: {
    ...mermaidBase,
    themeVariables: mermaidTheme('#3DDC84'),
  },
  base: '/android/',
  title: 'Android',
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: '学习路径', link: '/path' },
      {
        ...
        { text: "Android", link: "https://java-px.bot.cd/android/" },
    ...
    footer: {
      message: '安卓 Android 全栈知识图谱 - Kotlin / Jetpack / Compose / 系统层 / 跨平台 · 📚 <a href="https://java-px.bot.cd/android/" target="_blank">android 站主页</a> · 🏠 <a href="https://java-px.bot.cd/" target="_blank">门户首页</a>',
