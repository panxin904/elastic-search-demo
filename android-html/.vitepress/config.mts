 ...
 *   android         e.g. "ai", "java", "clickhouse"
 *   /android/       e.g. "/ai/", "/clickhouse/"
 *   Android      e.g. "AI 工程全栈"
 *   安卓 Android 全栈知识图谱 - Kotlin / Jetpack Compose / 系统层 Binder ART / 跨平台 Flutter RN / Gradle 性能优化 · 6 大类 · 89 节点       e.g. "系统化学习 AI 工具..."
 *   #3DDC84     e.g. "#8b5cf6"
 *   zh-CN       e.g. "zh-CN"
 *   安卓 Android 全栈知识图谱 - Kotlin / Jetpack / Compose / 系统层 / 跨平台 · 📚 <a href="https://java-px.bot.cd/android/" target="_blank">android 站主页</a> · 🏠 <a href="https://java-px.bot.cd/" target="_blank">门户首页</a>  e.g. "AI 工程全栈 - 工具 / 大模型 / SDK / Agent"
